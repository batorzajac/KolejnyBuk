        ...
        <!-- Page Content -->
          <div class="w-90 p-5" >
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                   <h3 style="font-family: 'Audiowide'; color:#fff200; font-weight:bold"> O NAS</h3>
                    <p style="color: white">  Swoje istnienie na polskim rynku zakładów bukmacherskich zawdzięczamy licencji Ministerstwa Finansów, regulującej zakłady online
                        na terenie Rzeczpospolitej Polskiej. </p>
                    <p style="color: white"> Dzięki temu, usługi świadczone przez nas w pełni umożliwiają Wam dostęp do profesjonalnej oferty zakładów sportowych.

                    <p style="color: white">Bukmacher to pewna marka, budząca głębokie zaufanie jej użytkowników. Przekonały się już o tym rzesze graczy naszych zakładów sportowych, a internetowe fora opiniotwórcze stwierdzają jednogłośnie, że jesteśmy wschodzącą gwiazdą polskiego rynku.</p>
                    <!-- /.card -->
