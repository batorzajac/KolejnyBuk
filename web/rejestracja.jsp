        ...
        <div class="w-90 p-5" >
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div>
                        <h3 style="font-family: 'Audiowide'; color:#fff200; font-weight:bold"> ZAREJESTRUJ SIĘ</h3>
                        <form name="form" action="regDB.jsp" method="post">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="password" name="password" class="form-control" id="password" style="width: 300px;"required >
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <label style="color:white">Potwierdz hasło</label>
                                    <input type="password" name="conpassword" class="form-control" style="width: 300px;"required>
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <label style="color:white">Imie</label>
                                    <input type="text" name="name" class="form-control" style="width: 300px;"required>
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="surname" class="form-control" style="width: 300px;"required>
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="number" name="phone" class="form-control" style="width: 300px;"required>

                                </div>
                            </div>
                            
                            <button type="submit" class="btn btn-primary" style="background-color: #fff200; color:black; font-weight: bold; height: 40px; width: 150px; ">ZAREJESTRUJ</button>
