<%-- 
    Document   : zakKup
    Created on : 2018-09-11, 17:17:14
    Author     : MatekTSW
--%>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <% try {
                            ...
                            String query2 = "select w.id as wid, w.nazwa as wnazwa, rg.nazwa as rgnazwa, d.nazwa as dnazwa,rg.id as rgid, w.data_wydarzenia,w.status as wstatus from Wydarzenie w join Rozgrywki rg on  rg.id=w.rozgrywki_id join Dyscyplina d on d.id=rg.dyscyplina_id order by d.id, rg.id,w.data_wydarzenia ";
                            Statement st2 = con2.createStatement();
                            ResultSet rs4 = st2.executeQuery(query2);
                            String edys = "";
                            int ecdedys = 0;
                            int ecderozg = 0;
                            int fecdedys = 2;
            ...
            <div style="width:100%;background-color: black">
                <div class="list-group">
                    ...
                    <%                        try {
                            ...
                            int idWar = Integer.parseInt(request.getParameter("idWar"));
String x;
                            int miejsce = 0;
                            int zaklad;
                            for (int i = 0; i < 8; i++) {
                                ...
                                if ((session.getAttribute("zak" + (i + 1)) == null)||(zaklad==0)) {
                                    session.setAttribute("zak" + (i + 1), idWar);
                                    miejsce = 1;
                                    break;
                                }
                            }
