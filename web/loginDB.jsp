<%-- 
    Document   : loginDB
    Created on : 2018-09-11, 17:41:04
    Author     : MatekTSW
--%>
        ...
        <!-- Page Content -->
         <div class="w-90 p-5" >
            ...
            <div class="row">
                ...
                <div class="alert alert-success" role="alert">Zostałeś zalogowany!</div>
                <%
                    
                    
                } else {
                %>
                <div class="alert alert-warning" role="alert">Błędne dane logowania! Spróbuj jeszcze raz.</div><%              
            }
        %>
