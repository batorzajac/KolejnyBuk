            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div>
                        ...
                        <form name="form" action="loginDB.jsp" method="post">                            
                            ...
                            <button type="submit"  class="btn btn-primary" style="background-color: #fff200; color:black; font-weight: bold; height: 40px; width: 150px; ">ZALOGUJ</button>
