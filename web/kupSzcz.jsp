<%-- 
    Document   : kupSzcz
    Created on : 2018-09-13, 13:54:07
    Author     : MatekTSW
--%>
...
<html>
                ...
                <div class="col-lg-10">
                    ...
                    <div>
                       <%
                                          try {
                                              request.setCharacterEncoding("UTF-8");
                String kuponIDS = request.getParameter("idKup");
                int kuponID=Integer.parseInt(kuponIDS);
                String status="";
                String klasaR="";
  ...
  <tbody><%
                ...
                PreparedStatement pst8 = connection.prepareStatement("SELECT ks.kurs as kskurs, wz.status as wzstatus,wz.nazwa as wznazwa,w.nazwa as wnazwa, tz.nazwa as tznazwa from kupon_szczegol ks join wariant_zdarzenia wz on wz.id=ks.wariant_id join zdarzenie z on z.id=wz.zdarzenie_id join typ_zdarzenia tz on tz.id=z.typ_zdarzenia_id join wydarzenie w on w.id=z.wydarzenie_id where ks.kupon_id=?");
                pst8.setInt(1, kuponID);
                ...
                while (rs8.next()) {
                    ...
                    if(status.equals("aktywne"))
                       ...
                       %>
                       <tr class="<%=klasaR%>">
      <th scope="row"><%=kuponID%></th>
      <td><%=rs8.getString("wnazwa")%></td>
      <td><%=rs8.getString("kskurs")%></td>
